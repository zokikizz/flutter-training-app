            ...
            Container(
              ...
              child: TextButton(
                onPressed: () async {
                  ...
                  await activateAccount(activationCodeControl.text, passwordControl.text, emailControl.text).then((value) {
                    EasyLoading.dismiss();
                    Navigator.pushNamed(context, '/login');
                    EasyLoading.showSuccess('Password succesfuly setup. Please login.');
                  }).catchError((e) {
                    EasyLoading.dismiss();
